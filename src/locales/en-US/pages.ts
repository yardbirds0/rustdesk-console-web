export default {
  ...
  'pages.audits.operator': 'Operator',
  'pages.audits.targetType': 'Target type',
  'pages.audits.targetId': 'Target ID',
  'pages.audits.result': 'Result',
  'pages.audits.reason': 'Reason',
  'pages.audits.unknownUser': 'Unknown user',
